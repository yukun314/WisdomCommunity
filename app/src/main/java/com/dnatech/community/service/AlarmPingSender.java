...
class AlarmPingSender implements MqttPingSender {
	...
	public AlarmPingSender(NotificationService service) {
		if (service == null) {
	...
	@Override
	public void start() {
		String action =  "NotificationService.pingSender."+ comms.getClient().getClientId();
	...
	class AlarmReceiver extends BroadcastReceiver {
		...
		private String wakeLockTag = "NotificationService.client."+ that.comms.getClient().getClientId();
