...
//                        mTouchView.onSwipe(ev);
                        mTouchView.smoothCloseMenu();
                        boolean isOpen = mTouchView.isOpen();
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                mTouchPosition = pointToPosition((int) ev.getX(), (int) ev.getY());
                System.out.println("action_down mTouchView:"+(mTouchView != null));
                ...
                System.out.println("action_down mTouchView:"+(mTouchView != null));
                if( mTouchView != null){
                    System.out.println("action_down isOpen:"+mTouchView.isOpen());
                }
            ...
            case MotionEvent.ACTION_UP:
                if (mTouchState == TOUCH_STATE_X) {
                    if (mTouchView != null) {
                        ...
                        System.out.println("action_up isBeforeOpen:"+isBeforeOpen);
                        mTouchView.onSwipe(ev);
                        boolean isAfterOpen = mTouchView.isOpen();
                        System.out.println("action_up isAfterOpen:"+isAfterOpen);
                        System.out.println("action_up mTouchPosition:"+mTouchPosition);
